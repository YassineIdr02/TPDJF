...
import { deleteEtudiantAsync, Etudiant, getEtudiantAsync, getEtudiants, updateEtudiantAsync } from "../features/EtudiantSlice";
...

                            {
                                etudiants.map((etudiant: Etudiant, index: number) => (
                                    ...
                                    >
                                        ...
                                        <th onClick={() => handleUpdate(etudiant)}><FontAwesomeIcon icon={faPenToSquare} /></th>
                                        <th  onClick={() => handleDelete(etudiant)}><FontAwesomeIcon icon={faTrash} /></th>
